...
Readers of this document should be familiar with the following terminology from {{?RFC9499}}:
...
Note that in practice, a KSK signs also other key related RRsets at the apex, such as the CDS and CDNSKEY RRset.
